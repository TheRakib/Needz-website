  ...
  const services = [
    {
      ...
      description: "Professionell hjälp med flyttning och leverans av möbler, varor och andra föremål.",
      image:
    ...
    },
    {
      icon: ShoppingBag,
      title: "Köp åt mig",
      description: "Låt någon handla och leverera det du behöver, när du inte har tid eller möjlighet.",
      image:
    ...
    },
    {
      icon: Gift,
      title: "Bortskänkes",
      description: "Hitta eller ge bort saker du inte längre behöver till någon som kan använda dem.",
      image:
    ...
    },
    {
      icon: Recycle,
      title: "Återvinning",
      description: "Hjälp med att transportera och återvinna möbler, elektronik och andra föremål.",
      image:
    ...
    },
    {
      icon: Wrench,
      title: "VVS",
      description: "Akut hjälp med rörläggning, läckage, avlopp och andra VVS-problem dygnet runt.",
      image:
    ...
    },
    {
      ...
      description: "Certifierade elektriker för säkra och professionella elektriska installationer och reparationer.",
      image:
    ...
    <section id="services" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Alla våra proffs är certifierade, erfarna och redo att leverera snabb, högkvalitativ service direkt till din
            dörr.
          </motion.p>
        </div>
