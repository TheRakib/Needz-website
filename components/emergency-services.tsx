...
import { Wrench, Zap, Key, Droplet, FlameIcon as Fire, Shield } from "lucide-react"
  ...
  const emergencyServices = [
    {
      icon: Wrench,
      title: "VVS Jour",
      description: "Akut hjälp med vattenläckor, stopp i avlopp, trasiga rör och andra VVS-problem som inte kan vänta.",
      image:
    ...
    },
    {
      icon: Key,
      title: "Låssmed Jour",
      description: "Låst ute? Vi hjälper dig med låsöppning, låsbyte och andra akuta låsproblem oavsett tid på dygnet.",
      image:
    ...
    },
    {
      icon: Shield,
      title: "Säkerhetsjour",
      description: "Akut hjälp med säkerhetssystem, larm och andra säkerhetslösningar för ditt hem eller företag.",
      image:
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          >
            Vi erbjuder ett brett utbud av akuta tjänster för att hjälpa dig när du behöver det som mest. Alla våra
            jourtjänster är tillgängliga dygnet runt, alla dagar om året.
          </motion.p>
        </div>
