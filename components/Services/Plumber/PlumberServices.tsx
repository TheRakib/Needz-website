              ...
              <div className="flex flex-col gap-4">
                <div className="flex">
                  <div className="p-2 shadow-lg shadow-primary/70 rounded-full">
                    <Image
                      src={"/home/services/plumber/icon1.svg"}
                      height={44}
                      width={44}
                      alt="service-icon"
                    />
...
const serviceCardItems = [
  {
    ...
    title: "Water Heater",
    description:
      "Are you not getting any hot water into the property? Then it is most likely your water heater that is creating problems for you. ",
  },
  {
    id: 2,
    title: "Heat Pumps",
    description:
      "We service and install all types of heat pumps. Choosing a heat pump as a heat source in your home is an investment, not only for your wallet",
  },
  {
    id: 3,
    title: "Radiators and elements",
    description:
      "Are all your radiators cold? Or do they work flawlessly in some rooms and not at all in others? Then you need a plumbing technician! ",
  },
  {
    id: 3,
    title: "Ventilation",
    description:
      "Did you know that it is a plumber who fixes the ventilation? The correct term for plumbing technician actually means heating,",
  },
  {
    id: 4,
    title: "Pipe Service",
    description:
      "Maintenance or repairs of the pipes? No job is too small or too big for us. We also offer service and maintenance agreements for housing",
  },
  {
    id: 5,
    title: "Planning",
    description:
      "Do you have plans to install new pipes? Do you need to upgrade your heating system, or run a drain to your new attic? We help you from start to finish!",
  },
  {
    id: 6,
    title: "Renovations and new builds",
    description:
      "We help you plan for the replacement of everything from mixers to new pipes. When renovating all types of rooms with water and",
  },
];
